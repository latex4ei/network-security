...
\section*{Cross-Site Scripting (XSS)}
  ...
  \subsection{Script inclusion (XSSI)}
    ...
    \textbf{Direct sourcing}: Malicious script directly include by careless dev.

    \textbf{Call-back}: Use script from another website when user is still connected to this website from the malicious website.
