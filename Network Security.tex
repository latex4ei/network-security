...
identity in daily life
  ...
  \subsection{Authentication Protocols}
    ...
    \subsubsection{802.1x : Port-Based Network Access Control}
      ...
      \textbf{Identity and Security}: Authentication (Who?) , Authorization (What?) , Access Control, Policy enforcement
...
\section{Firewalls, IDS and NAT Traversal}
  ...
  \subsection{Firewalls}
    ...
    \textbf{Types:} simple packet filter, statefull filter, application layer proxy
