...
\section*{SQL Injection (SQLi)}
  ...
  \subsection{SQL code injection}
    ...
    \subsubsection{Inference}
      If DB doesn't return error msg $\Ra$ change behaviour of it to guess.
      % TODO --- Blind Injection (ok)
      %\texttt{http://www.example.com/product.php?product_id=\textcolor{red}{100 AND IF(version() like ‘5\%’, sleep(15), ‘false’));--}}
